		...
		var
			...
			init = function ($slider, settings, vars) {
				...
				if (settings.controlsPlayPause) {
					...
					buttons = settings.autoPlay ? '<a class="' + vars.prefix + 'toggle ' + vars.prefix + 'pause ' + vars.prefix + 'btn">' + settings.pauseText + '</a>' : '<a class="' + vars.prefix + 'toggle ' +  vars.prefix + 'btn">' + settings.playText + '</a>';
					vars.container.append(buttons);
